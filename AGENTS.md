...
- Version: **v0.35.0** (package version synced to tags — see `docs/RELEASING.md`).

## Commands

- `zig build` — build the library and example executables
- `zig build test` — run unit tests (295 tests, 0 leaks; leaks fail the run; count grows when libpq/libmariadb headers are present)
